...
namespace Viettut\Bundles\UserSystem\LecturerBundle\DependencyInjection;
 ...
 */
class ViettutUserSystemLecturerExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        /*
            ...
            Will internally get converted to an 'viettut_user_system_lecturer_profile' form-type service definition.
            Never set the template namespace to FOSUserBundle or RollerworksMultiUserBundle as this will create an endless recursion!
        */

        $factory->create('viettut_user_system_lecturer', array(
            array(
                /*
                ...
                'services_prefix' => 'viettut_user_system_lecturer',
                'routes_prefix' => 'viettut_user_system_lecturer',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'Viettut\Bundles\UserSystem\LecturerBundle\Entity\User',
                ...
                /*
                'group' => array(
                    'group_class' => 'Viettut\Bundles\UserSystem\LecturerBundle\Entity\Group',
